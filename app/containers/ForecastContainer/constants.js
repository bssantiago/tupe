/*
 *
 * ForecastContainer constants
 *
 */

/*
 *
 * Wccontainer constants
 *
 */

export const REQUEST_MATCHES = 'app/ForecastContainer/REQUEST_MATCHES';
export const REQUEST_MATCHES_SUCCEDDED = 'app/ForecastContainer/REQUEST_MATCHES_SUCCEDDED';
export const REQUEST_MATCHES_FAILED = 'app/ForecastContainer/REQUEST_MATCHES_FAILED';
export const SAVE_PREDICTION = 'app/ForecastContainer/SAVE_PREDICTION';
export const SAVE_PREDICTION_SUCCEDDED = 'app/ForecastContainer/SAVE_PREDICTION_SUCCEDDED';
export const SAVE_PREDICTION_FAILED = 'app/ForecastContainer/SAVE_PREDICTION_FAILED';
export const GET_PREDICTIONS_SUCCEDDED = 'app/ForecastContainer/GET_PREDICTIONS_SUCCEDDED';
export const GET_PREDICTIONS_FAILED = 'app/ForecastContainer/GET_PREDICTIONS_FAILED';


export const TOKEN = '06ad6c0bcf9840899a35a5504bf3050c';
export const ISO_COUNTRIES = [{ ccode: 'AF',
    cname: 'Afghanistan',
  },
  {
    ccode: 'AX',
